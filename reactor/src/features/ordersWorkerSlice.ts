...
const initialState: InitialState = {
	made: {name:'made',cards:[{id:1, name: 'ACFW.00.0000', user_id: null},{id:2, name: 'ACFW.00.0025', user_id: null}]},
	process: {name:'process',cards:[{id:3, name: 'ACFW.00.0033', user_id: 1},{id:4, name: 'ACFW.00.0041', user_id: 2}]},
	ready: {name:'ready', cards:[{id:5, name: 'ACFW.00.0055', user_id: 5},{id:6, name: 'ACFW.00.0098', user_id: 6}]}
}
