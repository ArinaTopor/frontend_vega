...
const AddEmployeePage = () =>{
	...
	return (
		...
		background="var(--auth-background)">
			<Box sx={boxStyle}>
			<Flex mb='1.9vh'>
				<Button sx={isAdmin ? activeChoiceStyle : choiceStyle} value='admin' onClick={e=> handlerClick(e)}>
					Начальник
				</Button>
				<Button sx={!isAdmin ? activeChoiceStyle : choiceStyle} value='worker' onClick={e=> handlerClick(e)}>
					Новый работник
				</Button>
			</Flex>
